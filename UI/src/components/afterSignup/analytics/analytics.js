            ...
            <div className='analytics-wrapper'>
                <div className='analytics-row-1'>
                  <div className='cpb-div'>
                    <PercentDiv value={0.67} header={"Similarity Score"} />
                  </div>
                  <div className='wc-div'>
                    ...
                    <div className='cpb-div'>
                      <PercentDiv value={0.77} header={"Keyword Match Rate"} />
                    </div>
                </div>
                <div className='analytics-row-2'>
                  <TextDiv value={1234} header={"Words in Resume"}/>
                  <TextDiv value={786} header={"Keywords in Resume"}/>
                  <TextDiv value={344} header={"Words in Job Description"}/>
                  <TextDiv value={250} header={"Matched Keywords"}/>
                </div>
            </div>
        );
    }
